...
public class CommentVO {
	/*
	 * create table comment( cno int not null auto_increment, bno int default 0,
	 * writer varchar(100) default ”unknown”, content varchar(1000) not null,
	 * reg_date datetime default now(), primary key(cno));
	 */
	private int cno;
	private int bno;
