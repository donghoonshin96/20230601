			...
			<div class="row">
				<div class="col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-5">
					<div class="profile-card card rounded-lg shadow p-6 p-xl-5 mb-4 text-center position-relative overflow-hidden" style="margin-left: -180px;">
						...
						<img src="/resources/img/user1.jpg" alt="유저" class="img-circle mx-auto mb-3">
						<h3 class="mb-4">회원정보</h3>
						<div class="text-left mb-4 "style="margin-left: 100px;">
							<p class="mb-2"><i class="fa fa-user mr-2"></i> ${ses.id}님이 로그인 하였습니다. <br></p>
							<p class="mb-2"><i class="fa fa-database mr-2"></i> 계정 생성일: ${ses.reg_date}<br></p>
							<p class="mb-2"><i class="fa fa-calendar mr-2"></i> 최근 방문일: ${ses.last_login}<br></p>
						</div>
